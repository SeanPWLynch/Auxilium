...
/**
 * This class is a custom made table model to hold logs.
 * 
 * @author Gavin Kenna
 * @author Sean Lynch
...
public class logTableModel extends AbstractTableModel
{
	...
	public static void filterRows(String dateFrom, String dateTo)
	{
		//20/4/12 added new code here - Gavin
		if(dateFrom.equals(null) || dateFrom.equals(""))
		{
			dateFrom = "01-Jan-00";
		}
		if(dateTo.equals(null)|| dateTo.equals(""))
		{
			dateTo = "31-Dec-9999" ;
		}
		try
		{
			String queryString = "SELECT * FROM Log  where logdate between '"+dateFrom+"' and '"+dateTo+"'" ;
